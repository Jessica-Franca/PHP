...
<body>
    ...
    <h1>Solicitação de Férias e Décimo Terceiro</h1>
    <div class="container">
        <form action="processar_solicitacao.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="formGroupExampleInput"
                    placeholder="Escreva seu nome completo" required><br><br>
            </div>
            ...
            <form>
                ...
                <select class="form-select form-select-lg mb-3" aria-label="Large select example" id="quantidade_dias"
